This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app). It requires [Audiophile API](https://github.com/bruncun/audiophile-api).
